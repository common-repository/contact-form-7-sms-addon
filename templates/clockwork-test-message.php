...
<div class="wrap">
  <div class="left-content">
    ...
    <p>You should now have received a text message to <?php print esc_html($_GET['to']); ?>. If you have not received this, copy and paste the contents of the textbox below into a support request.</p>
